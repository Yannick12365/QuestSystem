...
public class EditSingleQuestMenu extends CustomMenu implements Closeable, SlotCondition, Subdevideable {
    ...
    public EditSingleQuestMenu(int size, int questID, NPC npc, ItemStack questBook) {
        super(size);
        this.questID = questID;
        this.n = npc.getName();
        setTitle("Quest verwalten" + questID);
    ...
    public InventoryContent getContents(Player player) {
        ...
        content.addGuiItem(13, new InventoryItem(questBook, ()->{})); //TODO Formatieren
